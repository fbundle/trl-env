...
def main(mode: Mode, uuid: str):
    ...
    output_dir = f"mnt/output/discrete-logarithm-v2-{os.path.basename(model_path)}-instruct-tl{max_turn_length}-cl{max_conversation_length}-b{effective_batch_size}-{uuid}-lora"
