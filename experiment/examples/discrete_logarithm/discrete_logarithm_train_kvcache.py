...
from trl_env.batch_rollout_kvcache import make_reward_func, make_rollout_func
from trl_env.model_kvcache import TransformerModelWithKVCache as TransformerModel
...
def main(mode: Mode, uuid: str):
    ...
    output_dir = f"mnt/output/discrete-logarithm-{os.path.basename(model_path)}-tl{max_turn_length}-cl{max_conversation_length}-b{effective_batch_size}-{uuid}-kvcache"
